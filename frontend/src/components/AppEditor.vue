<template>
  <EditorContent
    :editor="editor"
    class="editor flex w-full max-w-4xl m-10 bg-slate-50 leading-8 rounded-lg ring-1 ring-slate-500 focus-within:ring-4 focus-within:ring-indigo-500 tracking-wide transition-all"
  />
