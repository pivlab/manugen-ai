...
1. Analyze the user's input. Identify instructions, requests, ideas (both concrete or broad), broad
...
abstract, introduction, results, etc). Keep in mind that instructions/requests/ideas
can only belong to one specific section, not to multiple ones. If there are no
